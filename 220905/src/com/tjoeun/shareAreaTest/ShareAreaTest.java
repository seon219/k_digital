...
public class ShareAreaTest {
	...
	public static void main(String[] args) {
		...
		// 공유 영역으로 사용할 클래스 객체 선언
		// 기본자료형으로 선언한 변수는 일반 변수, 클래스로 선언한 변수(객체, 인스턴스) 참조 변수라 부름
		// 일반 변수는 데이터 자체를 기억하지만 참조변수는 생성되는 크기를 특정지을 수 없으므로,
		// 클래스로 만든 변수는 메모리 어딘가에 객체가 생성되면 그 객체가 생성된 주소를 기억
...
//		// 공유 영역을 만드는 2번째 방법
//		// 공유 영역을 공유해서 사용할 클래스의 객체를 선언할 때 생성자의 인수로 공유영역의 주소를 넘겨줌
