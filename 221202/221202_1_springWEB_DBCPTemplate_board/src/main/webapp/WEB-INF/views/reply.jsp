...
<body>
	...
	<input type="hidden" name="lev" value="${vo.lev}"> <!-- 질문글의 레벨 -->
	...
	<input type="hidden" name="currentPage" value="${currentPage}"> <!-- 답글 입력 후 돌아갈 페이지 번호 -->
		...
		<table width="600" align="center" border="1" cellpadding="5" cellspacing="0">
			...
			<tr>
				<th>내용</th>
				<td>
					<textarea rows="3" name="content" style="resize: none; width: 98%;"></textarea>
				</td>
			</tr>
			<tr>
				<td colspan="2" align="center">
					...
					<input type="button" value="목록으로" onclick="location.href='list.nhn?currentPage=${currentPage}'">
				</td>
			</tr>
		</table>
	</form>
