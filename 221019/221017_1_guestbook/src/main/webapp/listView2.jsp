			...
			<td colspan="6" align="center">
				...
				<c:if test="${guestbookList.startPage > 1}">
					<button 
						...
						onclick="location.href='?currentPage=${guestbookList.startPage - 1}'">이전
					</button>
				</c:if>
				...
				<c:if test="${guestbookList.endPage < guestbookList.totalPage}">
					<button type="button" 
							class="button button1" 
							title="10페이지 뒤로 이동하기" 
							onclick="location.href='?currentPage=${guestbookList.endPage + 1}'">다음
					</button>
				</c:if>
				...
				<c:if test="${guestbookList.currentPage < guestbookList.totalPage}">
					<button type="button" 
							class="button button1" 
							title="마지막 페이지로 이동하기" 
							onclick="location.href='?currentPage=${guestbookList.totalPage}'">마지막
					</button>
				</c:if>
