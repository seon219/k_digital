...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		System.out.println("취미: " + student.getHeight());
		System.out.println("================================================================");
		
		Student student2 = ctx.getBean("student", Student.class);
		System.out.println(student2);
		System.out.println("이름: " + student2.getName());
		System.out.println("취미: " + student2.getHeight());
		System.out.println("================================================================");
...
//		student와 student2는 같은 bean을 저장하고 있으므로 비교하면 같다.
		...
		System.out.println("취미: " + student3.getHeight());
		System.out.println("================================================================");
		
//		student와 student3는 내용은 같지만 다른 bean을 저장하고 있으므로 비교하면 다르다.
...
//		equals() 메소드를 Override 해주면 된다.
		...
		System.out.println("취미: " + student4.getHeight());
		System.out.println("================================================================");
		...
		System.out.println("취미: " + student5.getHeight());
		System.out.println("================================================================");
