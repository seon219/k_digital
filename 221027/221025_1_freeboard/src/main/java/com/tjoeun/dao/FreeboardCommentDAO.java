...
public class FreeboardCommentDAO {
	...
	public ArrayList<FreeboardVO> selectCommentList(SqlSession mapper, int idx) {
		System.out.println("FreeboardCommentDAO의 selectCommentList()");
		return (ArrayList<FreeboardVO>) mapper.selectList("selectCommentList", idx);
	}
	...
	// 댓글 1건을 삭제하는 freeboardcomment.xml 파일의 update sql 명령을 실행하는 메소드
