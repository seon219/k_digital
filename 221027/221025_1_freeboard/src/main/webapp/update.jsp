	...
	<form action="updateOK.jsp" method="post">
		...
		<table class="table table-bordered" style="width: 700px; margin-left: auto; margin-right: auto;">
			...
			<tr>
				...
				<td colspan="2">
					<input id="subject" class="form-control" type="text" name="subject" value="${vo.subject}">
				</td>
				
				<th class="align-middle">
					<c:if test="${fn:trim(vo.notice) == 'yes'}">
						공지글 <input class="form-check-input" type="checkbox" name="notice" value="no" checked="checked">
					</c:if>
					<c:if test="${fn:trim(vo.notice) != 'yes'}">
			...
			<tr>
				...
				<td colspan="3" align="left">
					<textarea rows="10" id="content" class="form-control" name="content" style="resize: none">${vo.content}</textarea>
				</td>
			</tr>
			<tr>
				<td colspan="4">
					<div class="row g-3 align-items-center" style="width: 90%; margin-left: auto; margin-right: auto;">
						...
						<div class="col-auto">
							<input class="btn btn-light btn-outline-danger" type="submit" value="수정하기">
