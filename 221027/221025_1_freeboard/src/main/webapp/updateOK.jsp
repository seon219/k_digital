...
<body>
	...
	<%
		...
		// update.jsp에서 넘어오는 수정할 글번호, 수정 후 돌아갈 페이지 번호, 수정하기 위해서 입력한 비밀번호를 받는다.
	...
	<%
		...
		// 수정할 글의 비밀번호와 수정하기 위해 입력한 비밀번호를 비교하기 위해서 수정할 글을 얻어온다,
		FreeboardVO original = service.selectByIdx(vo.getIdx());
		
		
		// 수정할 글의 비밀번호가 수정하기 위해 입력한 비밀번호와 비교해서 같으면 글을 수정한 후 목록으로 돌아가고,
