package com.thoeun.springDI_xml_setter;
...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		*/
		...
		//	=> Spring Bean Configuration File => xml 파일명을 입력하고 => Finish 버튼 클릭
		
		// xml 파일에서 설정한 bean을 얻어온다.
		// applicationVTX.xml이 위치한 경로 src/main/resources를 classpath라고 부른다,
		String configLocation = "classpath:applicationCTX.xml";
		
		// AbstractApplicationContext 클래스 생성자의 인수로 bean을 설정하는 xml 파일의 경로와 이름을 넘겨주면 
		// xml 파일의 내용을 읽어서 java 객체로 변환한 후 부모 클래스인 AbstractApplicationContext 클래스 객체에 저장
