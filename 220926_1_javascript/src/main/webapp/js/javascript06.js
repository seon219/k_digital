...
// dog 객체의 say() 함수를 cat 객체의 say() 함수로 주입
cat.say2 = dog.say;
console.log(cat);
cat.say2();
console.log('=====================================');
...
const numbers = {
	...
	get sum() {
		// getter는 특정 멤버의 값이나 연산 결과를 얻어와야 하므로 일반적으로 값을 return시켜야 한다.,
...
// numbers.sum(); // numbers is not a function 에러가 발생
// getter를 실행할 때는 함수 이름 뒤에 ()를 붙이면 된다.
