function numTest(num) {
	...
	// 덧셈을 제외한 나머지 연산은 문자열과 숫자를 연산해도 결과가 숫자로 처리됨
	console.log(num - 123);
	console.log(num * 123);
	console.log(num / 123);
	console.log(num % 123);
	...
	// '100a'와 같이 인수로 지정된 문자열에 숫자로 변환할 수 없는 문자가 있을 경우,
	// parseInt() 함수나 parseFloat()는 변환시킬 수 있는데까지 변환을 하지만,
	// Number()는 숫자로 변환할 수 없는 문자열이 포함된 경우 NaN을 출력
